                ...
                <div class="card  card-primary card-outline">
                    <div class=" card-body box-profile">
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Nomor Batch</label>
                            <div class="col-sm-10">
                                <select id="nomor_batch" onchange="tampilData()" required class=" select2 custom-select">
                                    <option value=''>--PILIH--</option>
                                    <?php
                                    foreach ($batch['data'] as $rows) {

                                    ?>

                                        <option value='<?php echo $rows['NomorBatch']; ?>'><?php echo $rows['NomorBatch']; ?></option>
...
<script>
    function tampilData() {
        ...
        $.ajax({
            ...
            async: false,
            data: {
                NomorBatch: $("#nomor_batch").val()
            },
            url: '<?php echo base_url(); ?>/servicewilayah/read_sls_by_batch',
            dataType: 'json',
            success: function(output) {
                ...
                for (var i = 0; i < outputData.length; i++) {
                    ...
                    TabelRealisasi.fnAddData([
                        "33 17 " + outputDataBaris.KdKec + " " + outputDataBaris.KdDesa + " " + outputDataBaris.KdSls + "",
                        "" + outputDataBaris.nama_desa + "",
                        "" + outputDataBaris.NmSls + "",
                        "" + outputDataBaris.HasilVerifikasi + "",
                        "" + outputDataBaris.Xk + "",
                        " <input targetkolom='Operator' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " value='" + outputDataBaris.Operator + "' class='Operator'>",
                        "<input targetkolom='TanggalEntri' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " class='tunggalTanggal' value='" + outputDataBaris.TanggalEntri + "' type='text'>",
                        "<input targetkolom='TanggalKembali' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " class='tunggalTanggal' value='" + outputDataBaris.TanggalKembali + "' type='text'>",
                        " <input targetkolom='Validator' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " value='" + outputDataBaris.Validator + "' class='Operator'>",
                        " <input targetkolom='TanggalValidasi' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " value='" + outputDataBaris.TanggalValidasi + "' class='tunggalTanggal'>",
                        " <input targetkolom='TanggalValidasiKembali' size=10 onchange='UpdateData(this)' targetid=" + outputDataBaris.Id + " value='" + outputDataBaris.TanggalValidasiKembali + "' class='tunggalTanggal'>",
